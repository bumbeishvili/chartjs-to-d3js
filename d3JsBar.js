function drawD3JsBar(selector) {
  ...
  //#####################   ARROWS ######################
  var arrows = body.selectAll('.arrows')
    .data(data)
    .enter()
    .append('path')
    .attr("transform", function (d, i) {
      return 'translate(' + (xScale(i) + dynamic.barCellLeftMargin - 10) + ',' + (yScale(d.value) - 90) + ')';
    })
    .attr('d', 'M 33 0 L 0 22 L 22 22 L 22 77 L 44 77 L 44 77 L 44 22 L 66 22 L 33 0 ')
    .attr('fill', 'teal')
    .attr('display', 'none')
